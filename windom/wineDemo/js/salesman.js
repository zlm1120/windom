				...
				if(json.status==1){
					...
					html += '<img src="'+banner+'" style="z-index: 0;"/>'+
						'<div class="banner_font">'+
							...
							if(androidUrl==null || androidUrl == "" ||  androidUrl == undefined){
						
							}else{
								html += '<img src="'+androidUrl+'" class="imgOne"/>';
							}
							if(iosUrl==null || iosUrl == "" ||  iosUrl == undefined){
						
							}else{
								html += '<img src="'+iosUrl+'" class="imgOne"/>';
							}
					html += '</div>';
					$("#adBnner").html(html);
